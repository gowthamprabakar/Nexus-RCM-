...
export function PreBatchScrubLayout() {
    ...
    return (
        <PreBatchProvider>
            <div className="flex flex-col h-full bg-slate-50 dark:bg-background-dark font-sans overflow-hidden">
                {/* Header */}
                <div className="bg-white dark:bg-card-dark border-b border-slate-200 dark:border-border-dark px-6 py-4 flex items-center justify-between shrink-0">
                    <div>
                        <div className="flex items-center gap-2 text-xs font-medium text-slate-400 mb-1">
                            <span>Claims</span>
                            <span className="material-symbols-outlined text-xs">chevron_right</span>
                            <span className="text-slate-900 dark:text-white">Validation & Scrubbing</span>
                        </div>
                ...
                {/* Sub-Navigation (Tabs) */}
                <div className="bg-white dark:bg-card-dark border-b border-slate-200 dark:border-border-dark px-6 flex gap-2 shrink-0">
                    <button
