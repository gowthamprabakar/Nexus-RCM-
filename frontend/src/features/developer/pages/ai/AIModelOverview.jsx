...
export function AIModelOverview() {
 ...
 <p className="text-th-muted font-mono text-sm mt-1">Telemetry Live: 2023-10-27T14:42:01Z // Cluster: us-east-1-rcm-04</p>
 </div>
 ...
 {/* Card 1 */}
 <div className="bg-white border border-th-border border-l-[3px] border-l-primary p-5 rounded-xl shadow-sm hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
 <div className="flex justify-between items-start mb-4">
 <div>
 <p className="text-[11px] text-th-muted font-bold uppercase tracking-widest">Model Alpha</p>
 <h3 className="text-lg font-bold text-th-heading">Denial Predictor</h3>
 </div>
 ...
 <p className="text-3xl font-mono font-bold text-primary tabular-nums">0.12</p>
 </div>
 <div>
 <p className="text-[10px] text-th-muted uppercase">Latency</p>
 <p className="text-3xl font-mono font-bold text-th-heading tabular-nums">45<span className="text-sm font-normal text-th-secondary">ms</span></p>
 </div>
 </div>
 <div className="mt-4 pt-4 border-t border-th-border-subtle flex items-center gap-3">
 <div className="flex-1 h-8 bg-th-surface-overlay rounded relative overflow-hidden">
 ...
 <span className="text-[10px] font-mono text-primary tabular-nums">+0.02%</span>
 </div>
 </div>

 {/* Card 2 */}
 <div className="bg-white border border-th-border border-l-[3px] border-l-blue-500 p-5 rounded-xl shadow-sm hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
 <div className="flex justify-between items-start mb-4">
 <div>
 <p className="text-[11px] text-th-muted font-bold uppercase tracking-widest">Model Beta</p>
 <h3 className="text-lg font-bold text-th-heading">Coding Agent</h3>
 </div>
 ...
 <div>
 <p className="text-[10px] text-th-muted uppercase">Drift Score</p>
 <p className="text-3xl font-mono font-bold text-primary tabular-nums">0.05</p>
 </div>
 <div>
 <p className="text-[10px] text-th-muted uppercase">Latency</p>
 <p className="text-3xl font-mono font-bold text-th-heading tabular-nums">120<span className="text-sm font-normal text-th-secondary">ms</span></p>
 </div>
 </div>
 <div className="mt-4 pt-4 border-t border-th-border-subtle flex items-center gap-3">
 <div className="flex-1 h-8 bg-th-surface-overlay rounded relative overflow-hidden">
 ...
 <span className="text-[10px] font-mono text-primary tabular-nums">-0.01%</span>
 </div>
 </div>

 {/* Card 3 */}
 <div className="bg-white border border-red-500/50 border-l-[3px] border-l-red-500 p-5 rounded-xl shadow-[0_0_15px_rgba(255,77,77,0.1)] hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
 <div className="flex justify-between items-start mb-4">
 <div>
 <p className="text-[11px] text-th-muted font-bold uppercase tracking-widest">Model Gamma</p>
 <h3 className="text-lg font-bold text-th-heading">Revenue Forecaster</h3>
 </div>
 ...
 <div>
 <p className="text-[10px] text-th-muted uppercase">Drift Score</p>
 <p className="text-3xl font-mono font-bold text-red-500 tabular-nums">0.28</p>
 </div>
 <div>
 <p className="text-[10px] text-th-muted uppercase">Latency</p>
 <p className="text-3xl font-mono font-bold text-th-heading tabular-nums">80<span className="text-sm font-normal text-th-secondary">ms</span></p>
 </div>
 </div>
 <div className="mt-4 pt-4 border-t border-th-border-subtle flex items-center gap-3">
 <div className="flex-1 h-8 bg-red-50 rounded relative overflow-hidden">
 <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 30">
 <path d="M0 25 L20 20 L40 28 L60 15 L80 5 L100 2" fill="none" stroke="#ff4d4d" strokeWidth="1.5"></path>
 </svg>
 </div>
 <span className="text-[10px] font-mono text-red-500 tabular-nums">+12.4%</span>
 </div>
 </div>
 </div>
 ...
 <p className="text-xl font-mono font-bold text-red-500 tabular-nums">+0.142</p>
 </div>
 <div>
 <p className="text-[10px] text-th-muted uppercase">Confidence</p>
 <p className="text-xl font-mono font-bold text-th-heading tabular-nums">82.4%</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-[10px] font-mono text-th-muted tabular-nums">88%</span>
 </div>
 ...
 {/* Job 2 */}
 <div className="bg-th-surface-overlay/30 border border-th-border rounded-lg p-4 opacity-70">
 <div className="flex justify-between mb-2">
 <span className="text-xs font-bold text-th-heading uppercase">Denial Predictor v1.9</span>
 <span className="text-[10px] font-mono text-th-muted">WAITING</span>
 </div>
 <div className="w-full h-1.5 bg-th-surface-overlay rounded-full overflow-hidden mb-3">
 <div className="h-full bg-th-surface-overlay" style={{ width: '0%' }}></div>
 </div>
 <div className="flex items-center gap-2 text-[10px] text-th-muted">
 ...
 <div className="bg-th-surface-overlay/30 border border-th-border rounded-lg p-4 opacity-70">
 <div className="flex justify-between mb-2">
 <span className="text-xs font-bold text-th-heading uppercase">Revenue Forecaster Patch</span>
 <span className="text-[10px] font-mono text-th-muted">QUEUED</span>
 </div>
 <div className="flex items-center gap-2 text-[10px] text-th-muted mt-4">
 ...
 <p className="text-[10px] text-th-muted text-center mb-3">Worker Nodes Active: 14/16</p>
 ...
 <span className="text-th-heading">Payer ID (Eligibility)</span>
 <span className="text-primary font-bold tabular-nums">0.342</span>
 </div>
 ...
 <div className="space-y-2">
 <div className="flex justify-between text-[11px] font-mono">
 <span className="text-th-heading">Total Claim Amount</span>
 <span className="text-primary font-bold tabular-nums">0.211</span>
 </div>
 <div className="w-full h-3 bg-th-surface-overlay rounded-sm overflow-hidden">
 ...
 <div className="space-y-2">
 <div className="flex justify-between text-[11px] font-mono">
 <span className="text-th-heading">ICD-10 Code Complexity</span>
 <span className="text-primary font-bold tabular-nums">0.188</span>
 </div>
 <div className="w-full h-3 bg-th-surface-overlay rounded-sm overflow-hidden">
 ...
 <div className="space-y-2">
 <div className="flex justify-between text-[11px] font-mono">
 <span className="text-th-heading">Facility Provider Rating</span>
 <span className="text-primary font-bold tabular-nums">0.094</span>
 </div>
 <div className="w-full h-3 bg-th-surface-overlay rounded-sm overflow-hidden">
