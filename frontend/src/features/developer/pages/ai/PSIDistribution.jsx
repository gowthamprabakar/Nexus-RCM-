...
export function PSIDistribution() {
 ...
 <h2 className="text-3xl font-black text-th-heading tracking-tight text-uppercase">PSI Distribution Analysis</h2>
 <p className="text-th-secondary font-mono text-sm mt-1 uppercase tracking-wider">Metric: Population Stability Index // Target: Denial_Predictor_v4</p>
 </div>
 <div className="flex gap-3">
 <div className="bg-th-surface-raised border border-th-border border-l-[3px] border-l-primary rounded px-4 py-2">
 <p className="text-[10px] text-th-secondary uppercase font-bold">Current System PSI</p>
 <p className="text-xl font-mono text-primary font-bold tabular-nums">0.142 <span className="text-xs font-normal text-th-muted">(STABLE)</span></p>
 </div>
 ...
 <div className="bg-th-surface-raised border border-th-border border-l-[3px] border-l-primary rounded-xl p-6 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
 <div className="flex justify-between items-center mb-6">
 <div>
 <h3 className="text-lg font-bold text-th-heading">Cohort PSI Score Distribution</h3>
 <p className="text-sm text-th-secondary">Frequency of PSI scores across 1,200 sub-segments</p>
 </div>
 <div className="flex items-center gap-4 text-[10px] font-mono">
 <div className="flex items-center gap-1.5"><span className="w-3 h-3 bg-primary rounded-sm"></span> Stable (&lt;<span className="tabular-nums">0.1</span>)</div>
 <div className="flex items-center gap-1.5"><span className="w-3 h-3 bg-yellow-500 rounded-sm"></span> Warning (<span className="tabular-nums">0.1-0.2</span>)</div>
 <div className="flex items-center gap-1.5"><span className="w-3 h-3 bg-[#ff4d4d] rounded-sm"></span> High Drift (&gt;<span className="tabular-nums">0.2</span>)</div>
 </div>
 </div>
 {/* Bar Chart Visualization */}
 <div className="h-64 flex items-end gap-1 px-2 border-l border-b border-th-border">
 {[
 ...
 <div className="flex justify-between mt-2 text-[10px] text-th-secondary font-mono">
 <span>0.00 PSI</span>
 <span>0.10 PSI</span>
 <span>0.20 PSI</span>
 <span>0.30+ PSI</span>
 ...
 {/* Heatmap */}
 <div className="bg-th-surface-raised border border-th-border border-l-[3px] border-l-yellow-500 rounded-xl p-6 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
 <div className="flex justify-between items-center mb-6">
 <div>
 <h3 className="text-lg font-bold text-th-heading">PSI Drift Heatmap by Feature Category</h3>
 <p className="text-sm text-th-secondary">Temporal analysis of drift across logical feature groups</p>
 </div>
 ...
 <div className="flex flex-col justify-between py-2 text-[10px] font-bold text-th-secondary uppercase space-y-6">
 ...
 <div className="grid grid-cols-12 gap-1 text-[9px] font-mono text-th-secondary pt-1">
 ...
 <div className="bg-th-surface-raised border border-[#ff4d4d]/30 border-l-[3px] border-l-[#ff4d4d] rounded-xl p-6 shadow-[0_0_15px_rgba(19,236,236,0.15)] flex flex-col h-full hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200">
 <div className="mb-6">
 ...
 <h3 className="text-lg font-bold text-th-heading">ICD-10_Complexity_Index</h3>
 <p className="text-xs text-th-secondary mt-1">PSI Value: <span className="text-[#ff4d4d] font-mono font-bold tabular-nums">0.284</span></p>
 </div>
 <div className="flex-1 space-y-8">
 <div>
 <div className="flex justify-between items-center mb-4">
 <span className="text-[10px] text-th-secondary uppercase font-bold tracking-widest">Training vs. Production</span>
 <div className="flex gap-2">
 <span className="w-3 h-3 bg-white/20 rounded-full border border-white/40"></span>
 <span className="w-3 h-3 bg-primary rounded-full"></span>
 </div>
 </div>
 <div className="relative h-48 border-l border-b border-th-border px-2 flex items-end justify-between overflow-hidden">
 {/* Chart Placeholder */}
 ...
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#ff4d4d]/90 text-th-heading text-[9px] px-2 py-1 rounded font-bold uppercase tracking-widest -rotate-12">Mean Shift: +1.2σ</div>
 </div>
 <div className="flex justify-between mt-2 text-[9px] font-mono text-th-muted">
 <span>Low Complexity</span>
 <span>Med</span>
 <span>High Complexity</span>
 </div>
 </div>
 <div className="bg-th-surface-overlay/30 rounded-lg p-4 space-y-3">
 <h4 className="text-[10px] text-th-heading font-bold uppercase tracking-widest border-b border-th-border-subtle pb-2">Analysis Insight</h4>
 <p className="text-xs text-th-secondary leading-relaxed">
 Significant right-ward shift detected in clinical complexity values compared to training set (v2.4). This drift correlates with the recent expansion into <span className="text-th-heading font-mono">Territory_West_04</span>.
 </p>
