...
export function AlertsQueue() {
    ...
    const alerts = mockARData.alerts;
        ...
        <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-background-dark font-sans h-full">
            <div className="max-w-[1600px] mx-auto px-10 py-8">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
                    ...
                    <span className="text-slate-900 dark:text-white font-medium">Alerts & Follow-up Queue</span>
                </div>
                ...
                {/* Filter Tabs */}
                <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl shadow-sm overflow-hidden mb-6">
                    <div className="flex overflow-x-auto">
                        ...
                        >
                            All Alerts
                            <span className="ml-2 px-2 py-0.5 rounded-full text-xs bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300">
                                {counts.all}
                            </span>
                        </button>
                        <button
                        ...
                        >
                            Overdue Follow-ups
                            <span className="ml-2 px-2 py-0.5 rounded-full text-xs bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400">
                        ...
                        >
                            SLA Breaches
                            <span className="ml-2 px-2 py-0.5 rounded-full text-xs bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400">
                                {counts.sla_breach}
                            </span>
                        </button>
                        <button
                        ...
                        >
                            AI Alerts
                            <span className="ml-2 px-2 py-0.5 rounded-full text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400">
                                {counts.ai_triggered}
                            </span>
                        </button>
                        <button
                        ...
                        >
                            Payment Promises
                            <span className="ml-2 px-2 py-0.5 rounded-full text-xs bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400">
                ...
                {selectedAlerts.length > 0 && (
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 mb-6 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <button className="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-bold hover:bg-slate-50 transition-colors">
                                Assign to User
                            </button>
                            <button className="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-bold hover:bg-slate-50 transition-colors">
                                Snooze
                                    ...
                                    <tr key={alert.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-bold text-slate-900 dark:text-white capitalize">{alert.priority}</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-slate-700 dark:text-slate-300">{getAlertTypeLabel(alert.type)}</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <div>
                                                <p className="font-bold text-slate-900 dark:text-white">{alert.patient}</p>
                                                <p className="text-xs text-slate-500 dark:text-slate-400">{alert.mrn}</p>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <p className="text-slate-700 dark:text-slate-300 max-w-md">{alert.message}</p>
                                            {alert.daysOverdue > 0 && (
