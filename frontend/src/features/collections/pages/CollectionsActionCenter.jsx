...
export function CollectionsActionCenter() {
    ...
    const templates = mockARData.actionTemplates;
    const dispositions = mockARData.dispositionCodes;
    const escalationReasons = mockARData.escalationReasons;
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Collections Action Center</h1>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent"
                        >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white resize-none"
                        />
                    </div>
                        ...
                        <>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={12}
                                    className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white font-mono text-sm resize-none"
                                />
                            </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 space-y-6">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-2xl font-bold text-primary">{settlementDiscount}%</span>
                        </div>
                        <input
                            type="range"
                            min="10"
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-1">Original Balance</p>
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-lg space-y-4">
                        <h3 className="font-semibold text-slate-900 dark:text-white">Or Offer Payment Plan</h3>
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                <label className="text-sm font-medium text-slate-700 dark:text-slate-300">
                                    Number of Months
                                </label>
                                <span className="text-lg font-bold text-slate-900 dark:text-white">{paymentPlanMonths} months</span>
                            </div>
                            <input
                                type="range"
                                min="3"
                        ...
                        <div className="flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded-lg">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Monthly Payment</span>
            ...
            {activeAction === 'escalation' && (
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white">
            ...
            {activeAction === 'status' && (
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 space-y-6">
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
                        ...
                        <p className="text-lg font-semibold text-slate-900 dark:text-white">{account.status}</p>
                    </div>
                    ...
                    {/* Action Buttons */}
                    <div className="flex justify-end gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                        <button className="px-6 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors">
                            Cancel
                        </button>
                        <button
                            onClick={handleLogAction}
