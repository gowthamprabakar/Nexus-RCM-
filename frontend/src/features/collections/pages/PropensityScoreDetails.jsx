...
export function PropensityScoreDetails() {
    ...
    const details = mockARData.propensityDetails;
        ...
        <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-background-dark font-sans h-full">
            <div className="max-w-[1600px] mx-auto px-10 py-8">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
                    ...
                    <span className="material-symbols-outlined text-xs">chevron_right</span>
                    <span className="text-slate-900 dark:text-white font-medium">Propensity Score Details</span>
                </div>

                {/* Page Header */}
                <div className="flex justify-between items-end mb-8">
                    <div>
                        <h1 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Propensity Score Analysis</h1>
                ...
                <div className="bg-gradient-to-br from-primary/10 to-blue-500/5 dark:from-primary/20 dark:to-blue-500/10 border border-primary/20 rounded-xl p-8 mb-8">
                    <div className="grid grid-cols-4 gap-8">
                        <div className="col-span-1">
                            <p className="text-sm text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-2">Current Score</p>
                            <p className={`text-6xl font-black ${getScoreColor(details.currentScore)}`}>{details.currentScore}</p>
                            <p className="text-sm text-slate-600 dark:text-slate-400 mt-2">{details.scoreLabel}</p>
                        </div>
                        <div className="col-span-3">
                            <p className="text-sm text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-4">Score History</p>
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-primary/20">
                        <div>
                            <p className="text-xs text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Confidence Level</p>
                            <p className="text-2xl font-black text-slate-900 dark:text-white">{details.confidence}%</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Model Version</p>
                            <p className="text-2xl font-black text-slate-900 dark:text-white">{details.modelVersion}</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1">Last Calculated</p>
                ...
                <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6 shadow-sm mb-8">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-lg font-black text-slate-900 dark:text-white">Feature Importance</h3>
                        ...
                        {details.featureImportance.map((feature, idx) => (
                            <div key={idx} className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-1">
                                            <h4 className="text-sm font-bold text-slate-900 dark:text-white">{feature.displayName}</h4>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Importance to Model</p>
                                    ...
                                    <div>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Impact on Score</p>
                                        <div className="flex items-center gap-2">
                                            <div className="flex-1 bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                                                <div
                                            ...
                                            <span className={`text-xs font-bold ${getImpactColor(feature.impact)}`}>
                ...
                <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6 shadow-sm mb-8">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-lg font-black text-slate-900 dark:text-white">What-If Analysis</h3>
                        <span className="text-sm text-slate-500 dark:text-slate-400 ml-2">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {details.whatIfScenarios.map((scenario, idx) => (
                            ...
                            >
                                <div className="flex items-start justify-between mb-3">
                                    <h4 className="text-sm font-bold text-slate-900 dark:text-white">{scenario.scenario}</h4>
                                    <span className={`text-lg font-black ${getImpactColor(scenario.scoreDelta)}`}>
                                ...
                                <div className="pt-3 border-t border-slate-200 dark:border-slate-800">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-xs text-slate-500 dark:text-slate-400">New Score</span>
                                        <span className={`text-xl font-black ${getScoreColor(scenario.newScore)}`}>
                                            {scenario.newScore}
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6 shadow-sm">
                        <h3 className="text-lg font-black text-slate-900 dark:text-white mb-4">Model Performance Metrics</h3>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                                <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Overall Accuracy</p>
                                <p className="text-2xl font-black text-emerald-600 dark:text-emerald-400">
                                    {(details.modelMetrics.overallAccuracy * 100).toFixed(0)}%
                                </p>
                            </div>
                            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                                <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Precision</p>
                                <p className="text-2xl font-black text-blue-600 dark:text-blue-400">
                                    {(details.modelMetrics.precision * 100).toFixed(0)}%
                                </p>
                            </div>
                            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                                <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Recall</p>
                                <p className="text-2xl font-black text-purple-600 dark:text-purple-400">
                                    {(details.modelMetrics.recall * 100).toFixed(0)}%
                                </p>
                            </div>
                            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                                <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">AUC Score</p>
                    ...
                    <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6 shadow-sm">
                        <h3 className="text-lg font-black text-slate-900 dark:text-white mb-4">Performance by Score Range</h3>
                ...
                <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6 shadow-sm mb-8">
                    <h3 className="text-lg font-black text-slate-900 dark:text-white mb-4">Historical Prediction Accuracy</h3>
                    <div className="grid grid-cols-4 gap-4">
                        {details.modelMetrics.historicalPredictions.map((pred, idx) => (
                            <div key={idx} className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                                <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">{pred.month}</p>
                ...
                <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6 shadow-sm">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-lg font-black text-slate-900 dark:text-white">Audit Trail</h3>
                    </div>

                    <div className="space-y-3">
                        {details.auditTrail.map((entry, idx) => (
                            <div key={idx} className="flex gap-4 pb-3 border-b border-slate-100 dark:border-slate-800 last:border-0">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-start justify-between mb-1">
                                        <h4 className="text-sm font-bold text-slate-900 dark:text-white">{entry.event}</h4>
                                        <span className="text-xs text-slate-500 dark:text-slate-400">
                                            {new Date(entry.timestamp).toLocaleString()}
                                        </span>
                                    </div>
                                    <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">{entry.details}</p>
