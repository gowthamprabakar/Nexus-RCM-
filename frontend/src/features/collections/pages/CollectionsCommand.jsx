...
export function CollectionsCommand() {
 ...
 <h3 className="text-3xl font-bold text-th-heading tabular-nums">$840,000</h3>
 <p className="text-sm font-medium text-th-muted mb-1.5 tabular-nums">/ $1.2M Target</p>
 </div>
 ...
 <span className="text-emerald-500 font-bold tabular-nums">70%</span> of target
 </p>
 </div>
 ...
 <h3 className="text-3xl font-bold text-th-heading tabular-nums">$145,000</h3>
 <p className="mt-3 text-xs text-th-secondary">Today's target reached: <span className="text-th-heading font-bold tabular-nums">82%</span></p>
 <div className="mt-4 flex gap-1">
 {[1, 1, 1, 1, 0].map((v, i) => (
 <div key={i} className={`h-1 flex-1 rounded-full ${v ? 'bg-primary' : 'bg-th-surface-overlay dark:bg-[#283539]'}`}></div>
 ))}
 </div>
 </div>
 {/* AI Alert Panel */}
 ...
 <div className="p-6 border-b border-th-border dark:border-[#283539] flex justify-between items-center">
 <h3 className="text-base font-bold text-th-heading ">Agent Activity Tracker</h3>
 ...
 <th className="px-6 py-3 border-b border-th-border dark:border-[#283539]">Time</th>
 <th className="px-6 py-3 border-b border-th-border dark:border-[#283539]">Agent / System</th>
 <th className="px-6 py-3 border-b border-th-border dark:border-[#283539]">Action</th>
 <th className="px-6 py-3 border-b border-th-border dark:border-[#283539]">Status</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-200 dark:divide-[#283539]">
 <tr className="hover:bg-th-surface-overlay/30 dark:hover:bg-white/5 transition-colors">
 <td className="px-6 py-4 text-xs text-th-secondary font-medium">14:02</td>
 <td className="px-6 py-4">
 <div className="flex items-center gap-2">
 <div className="size-6 rounded bg-primary/20 flex items-center justify-center text-primary">
 <span className="material-symbols-outlined text-[16px]">smart_toy</span>
 </div>
 <span className="text-xs font-bold text-th-heading ">AI Agent #04</span>
 </div>
 </td>
 <td className="px-6 py-4 text-xs text-th-muted ">Completed 42 Medicare follow-up calls</td>
