...
export function AIInsightDetailModal({ insight, onClose }) {
 ...
 >
 {/* Header */}
 <div className={`bg-gradient-to-r ${getImpactColor(insight.impact)} p-6 text-th-heading`}>
 ...
 <p className="text-th-muted text-xs font-bold mb-1">Impact Level</p>
 <p className="text-2xl font-black text-th-heading capitalize">{insight.impact}</p>
 </div>
 <div className="bg-th-surface-overlay/30 p-4 rounded-lg">
 <p className="text-th-muted text-xs font-bold mb-1">Confidence</p>
 <p className="text-2xl font-black text-th-heading ">{insight.confidence}%</p>
 </div>
 ...
 <div>
 <h3 className="text-lg font-bold text-th-heading mb-2">Recommended Action</h3>
 <p className="text-th-primary ">{insight.recommendation}</p>
 </div>
 </div>
 <button className="w-full bg-blue-600 text-th-heading py-3 rounded-lg font-bold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
 ...
 <h3 className="text-lg font-bold text-th-heading ">Supporting Analysis</h3>

 <div className="bg-th-surface-overlay/30 p-4 rounded-lg">
 <h4 className="font-bold text-th-heading mb-2 flex items-center gap-2">
 ...
 <button className="text-th-muted hover:text-th-heading dark:hover:text-th-heading font-bold text-sm flex items-center gap-1">
