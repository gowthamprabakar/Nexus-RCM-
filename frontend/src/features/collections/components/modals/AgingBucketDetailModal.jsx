        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
            ...
            >
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-280px)]">
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Claims in this Bucket</h3>
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                {sampleClaims.map((claim) => (
                                    <tr key={claim.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                        <td className="px-4 py-3 font-bold text-slate-900 dark:text-white">{claim.id}</td>
                                        <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{claim.patient}</td>
                                        <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{claim.payer}</td>
                                        <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{claim.dos}</td>
