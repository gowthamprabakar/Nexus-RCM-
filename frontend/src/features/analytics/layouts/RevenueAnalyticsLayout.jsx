...
export function RevenueAnalyticsLayout() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden font-sans">
      ...
      <div className="shrink-0 px-6 pt-5 pb-0 border-b border-th-border bg-th-surface-raised">
        <h1 className="text-xl font-black text-th-heading tracking-tight">Revenue Analytics</h1>
        <p className="text-sm text-th-secondary mb-3">Financial performance, reconciliation, and cash flow</p>
