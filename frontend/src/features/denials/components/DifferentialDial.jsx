...
export function DifferentialDial({ title, value, benchmark, status, trend, onClick, isActive }) {
 ...
 <div
 onClick={onClick}
 className={`bg-white rounded-xl border p-4 shadow-sm flex flex-col items-center cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-md ${isActive ? 'ring-2 ring-primary border-primary' : 'border-th-border '}`}
 >
