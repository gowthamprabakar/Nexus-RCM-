...
export function StatusPill({ status, size = 'sm' }) {
    const styles = {
        ...
        'Ignored': 'bg-slate-50 text-slate-700 ring-slate-600/20 dark:bg-slate-800/20 dark:text-slate-400',
    ...
    const defaultStyle = 'bg-slate-50 text-slate-700 ring-slate-600/20 dark:bg-slate-800/20 dark:text-slate-400';
