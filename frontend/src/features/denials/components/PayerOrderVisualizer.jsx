...
export function PayerOrderVisualizer({ currentOrder, suggestedOrder, conflictType }) {
 ...
 <div className="text-xs font-bold uppercase text-th-muted mb-2 flex justify-between">
 ...
 <div className="px-3 py-2 bg-th-surface-overlay border border-th-border rounded-lg text-sm font-semibold text-th-muted ">
 {payer}
 </div>
 {idx < current.length - 1 && (
 <span className="material-symbols-outlined text-th-secondary">arrow_forward</span>
 )}
 </React.Fragment>
 ))}
 </div>
 ...
 : 'bg-white border border-th-border text-th-primary '
 }
 `}>
 {payer}
 </div>
