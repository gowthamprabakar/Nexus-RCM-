...
export function AutomationAnalysisPanel({ claim }) {
 ...
 return (
 <div className="bg-white rounded-xl border border-th-border shadow-sm overflow-hidden mb-6 animate-fade-in">
 <div className="p-4 border-b border-th-border bg-amber-50/50 dark:bg-amber-900/10 flex justify-between items-center">
 ...
 <div className="absolute top-1/2 left-0 w-full h-0.5 bg-th-surface-overlay dark:bg-th-border -z-10 transform -translate-y-1/2"></div>
 <div className="flex justify-between relative z-0">
 <div className="text-center bg-white p-2 rounded-lg border border-th-border w-1/3">
 <div className="text-xs text-th-muted uppercase font-bold mb-1">Current Primary</div>
 <div className="font-bold text-th-heading ">{claim.payer || 'Medicare'}</div>
 </div>
 ...
 <div className="text-center bg-white p-2 rounded-lg border border-th-border w-1/3 opacity-50">
 <div className="text-xs text-th-muted uppercase font-bold mb-1">Current Secondary</div>
 <div className="font-bold text-th-heading ">BCBS</div>
 </div>
 </div>
 ...
 <div className="font-bold text-th-heading ">BCBS (Active)</div>
 </div>
 ...
 <div className="text-center bg-white p-2 rounded-lg border border-th-border w-1/3">
 <div className="text-xs text-th-muted uppercase font-bold mb-1">Correct Secondary</div>
 <div className="font-bold text-th-heading ">{claim.payer || 'Medicare'}</div>
 </div>
 </div>
 </div>
 ...
 {/* Timeline Data */}
 <div className="space-y-4 border-l border-th-border-subtle pl-8">
 <div className="relative pb-6 border-l-2 border-emerald-500 pl-4">
 <div className="absolute -left-[21px] top-0 w-3 h-3 bg-emerald-500 rounded-full ring-4 ring-white dark:ring-th-surface-base"></div>
 ...
 <p className="text-xs text-th-muted mt-1">Bot verified BCBS active coverage via portal.</p>
 </div>
 <div className="relative pb-6 border-l-2 border-th-border pl-4">
 <div className="absolute -left-[21px] top-0 w-3 h-3 bg-slate-300 rounded-full ring-4 ring-white dark:ring-th-surface-base"></div>
 <div className="text-xs text-th-secondary font-bold mb-1">2 Days Ago</div>
 <h4 className="font-bold text-sm text-th-muted">Claim Created</h4>
 <p className="text-xs text-th-muted mt-1">Submitted with default payer order.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 return (
 <div className="bg-white rounded-xl border border-th-border shadow-sm overflow-hidden mb-6 animate-fade-in">
 <div className="p-4 border-b border-th-border bg-indigo-50/50 dark:bg-indigo-900/10 flex justify-between items-center">
 <h3 className="font-bold text-th-heading flex items-center gap-2">
 ...
 <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
 {/* Mock Map View */}
 <div className="bg-th-surface-overlay rounded-lg p-4 relative overflow-hidden h-48 flex items-center justify-center border border-th-border ">
 ...
 <thead>
 <tr className="text-xs text-th-muted uppercase border-b border-th-border-subtle ">
 ...
 <td className="py-3 text-right text-th-secondary">-</td>
 </tr>
 <tr>
