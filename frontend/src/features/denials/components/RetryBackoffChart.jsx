...
export function RetryBackoffChart({ strategy = 'exponential' }) {
    ...
    return (
        <div className="h-64 w-full bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-border-dark p-4 shadow-sm">
            <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-4 flex items-center justify-between">
                ...
                <span className="text-xs bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded text-slate-500 capitalize">{strategy}</span>
            </h4>
