        ...
        <div className="flex-1 flex flex-col p-6 max-w-[1600px] mx-auto w-full gap-6 bg-slate-50 dark:bg-background-dark font-sans h-full overflow-y-auto">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-slate-900 dark:text-white font-medium">Reconciliation Center</span>
                </div>

                <div className="flex flex-wrap justify-between items-end gap-6">
                    <div className="flex flex-col gap-1 max-w-2xl">
                        <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Reconciliation Center</h1>
                        <p className="text-slate-500 dark:text-slate-400 text-sm">Unified control plane for Revenue Reconciliation, Cash Posting, and Bank Feeds.</p>
                    </div>
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800 p-1 rounded-lg flex items-center gap-1">
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-bold transition-all ${activeTab === 'revenue' ? 'bg-white dark:bg-card-dark text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
                        >
                            Revenue & Cash Posting
                        </button>
                        <button
                            onClick={() => setActiveTab('bank')}
                            className={`px-4 py-2 rounded-md text-sm font-bold transition-all ${activeTab === 'bank' ? 'bg-white dark:bg-card-dark text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
                        >
                            Bank Reconciliation
                        </button>
                    </div>
            ...
            {/* Content Area */}
            {activeTab === 'bank' ? (
                <div className="flex-1 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
                    <BankReconciliation />
                </div>
            ) : (
